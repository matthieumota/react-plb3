        ...
        <div className="divide-y-2 mb-8">
          {vegetables.map((vegetable, index) =>
            <div key={index} className="pt-3 mt-3 flex items-center gap-4">
              ...
              <p>{vegetable.price} €</p>
              <input type="text" value={vegetable.draftName} onChange={(event) => updateVegetableDraftName(event.target.value, index)} className="border border-gray-300 rounded-md" />
